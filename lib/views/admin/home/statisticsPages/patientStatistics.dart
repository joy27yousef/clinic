...
import 'package:clinik_app/views/admin/home/statisticsPages/widgets/patientTable.dart';
import 'package:clinik_app/views/admin/home/statisticsPages/widgets/statisticsPatientCard.dart';
          ...
          builder: (controller) {
            return Handilingdataview(
              ...
              widget: Padding(
                ...
                child: ListView(
                  children: [StatisticsPatientCard(), PatientTable()],
                ),
              ),
            );
          },
